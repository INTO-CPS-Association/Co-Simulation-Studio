...
describe("Linting language feature", () => {
    ...
    describe("RuleContext", () => {
        test("report should add a diagnostic to the collection", () => {
            const mockCosimConfig = new CosimulationConfiguration(
                mockDocument1
            );
    ...
    describe("DocumentQueueManager", () => {
        ...
        test("dequeueing a document should remove it from the queue", () => {
            ...
            const documentToDequeue =
                mockDocumentQueueManager.getDocuments()[0];
    ...
    describe("LintingManager", () => {
        ...
        beforeEach(() => {
            ...
            mockLintingManager = new lintingModule.LintingManager(mockDiagnosticsCollection);
        });
        ...
        test("lintDocuments should add diagnostics to the collection", async () => {
            ...
            expect(mockDiagnosticsCollection.get(mockDocument1.uri)).toHaveLength(1);
        });
    });
});
