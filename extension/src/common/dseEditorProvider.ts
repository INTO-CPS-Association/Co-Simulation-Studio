...
export class DseEditorProvider implements vscode.CustomTextEditorProvider {
	...
	private static readonly viewType = 'cosimulationstudio.editors.dseEditor';

	public static register(context: vscode.ExtensionContext): vscode.Disposable {
		const provider = new DseEditorProvider(context);
		const providerRegistration = vscode.window.registerCustomEditorProvider(DseEditorProvider.viewType, provider);
