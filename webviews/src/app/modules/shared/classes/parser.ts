...
export class Parser {
    ...
    private getInstance(multiModel: MultiModelConfig, id: string): Instance | null {
        ...
        if (Object.keys(data).indexOf(this.CONNECTIONS_TAG) >= 0) {
            ...
            $.each(Object.keys(connectionsEntry), (j, id) => {
                ...
                $.each(inputList, (j, inputId) => {
                    ...
                    if (inInstance != null && instance != null)
    ...
    parseLivestreamInternal(tag: string, data: any, multiModel: MultiModelConfig): Map<Instance, ScalarVariable[]> {
        ...
        if (livestreamEntry) {
            Object.keys(livestreamEntry).forEach(id => {
                ...
                let instance: Instance | null = multiModel.getInstance(fmuName, instanceName);
    ...
    parseAlgorithm(data: any, multiModel: MultiModelConfig): ICoSimAlgorithm | undefined {
