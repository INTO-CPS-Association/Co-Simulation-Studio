...
export class DseConfiguration implements ISerializable {
    ...
    fmuRootPath: string = '';
    multiModel: MultiModelConfig | null = null;
    ...
    public addScenario(): DseScenario | null {
...
export class GeneticSearch implements IDseAlgorithm { //FIXME  Previously discussed removing/changing IDseAlgorithm
    ...
    toFormGroup() {
        return new FormGroup({
            //PL-TODO initialPopulation: new FormControl(this.initialPopulation, [Validators.required, numberValidator]),
            //PL-TODO initialPopulationDistribution: new FormControl(this.initialPopulationDistribution, [Validators.required]),
            //PL-TODO mutationProbability: new FormControl(this.mutationProbability, [Validators.required, numberValidator]),
            //PL-TODO parentSelectionStrategy: new FormControl(this.parentSelectionStrategy, [Validators.required]),
            //PL-TODO maxGenerationsWithoutImprovement: new FormControl(this.maxGenerationsWithoutImprovement, [Validators.required, numberValidator])
        });
    }
