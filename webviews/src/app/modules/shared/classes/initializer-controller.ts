...
class InitializationController {
    ...
    private setTitle() {
        ...
        //PL-TODO let ipc: Electron.IpcRenderer = require("electron").ipcRenderer;
        //PL-TODO ipc.on(IntoCpsAppEvents.PROJECT_CHANGED, () => {
        //PL-TODO let p = app.getActiveProject();
        //PL-TODO this.title.innerText = "Project: " + p.getName() + " - " + p.getRootFilePath();
        //PL-TODO });
    }
