...
import { Reactivity, SigverConfiguration } from 'src/app/modules/shared/classes/configuration/sigver-configuration';
...
import IntoCpsApp
 from 'src/app/modules/shared/classes/into-cps-app';
@Component({
...
export class SigverConfigurationComponent {
	...
	updateCoeFileInConfPath(): Promise<void> {
		return new Promise<void>((resolve, reject) => {
			Fs.promises
	...
	copyCoeToConfigPath(): Promise<string> {
